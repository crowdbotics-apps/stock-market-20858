"""stock_market_20858 URL Configuration
...
admin.site.site_header = "Stock Market"
admin.site.site_title = "Stock Market Admin Portal"
admin.site.index_title = "Stock Market Admin"

# swagger
api_info = openapi.Info(
    title="Stock Market API",
    default_version="v1",
    description="API documentation for Stock Market App",
)
